                            ...
                            <form class="container" action="{{route('editar-producto',$producto->id)}}" method="POST" id="producto">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-sm-4">
                                        ...
                                        <input type="number" class="form-control" id="precio_base" name='precio_base' value='{{$producto->precio_base}}'>
                                    </div>
                                    <div class="mb-4 col-sm-4">
                                        <label for="impuesto" class="form-label">impuesto (%):</label>
                                        <input type="number" class="form-control" id="impuesto" name='impuesto' min="0,1" max="100" placeholder="10%" value="{{$producto->impuesto}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-4 col-sm-4">
                                        <label for="precio_total" class="form-label">Precio Total:</label>
                                        <input type="number" class="form-control" id="precio_total" name='precio_total' disabled value="{{$producto->precio_total}}">
                                    </div>
                                    <div class="mb col-sm">
